import { cart, removeFromCart, totalItemCount, addToCard, updateDeliveryOption } from '../data/cart.js';
...
console.log(deliveryDate.format('dddd,DD MMMM YYYY'));
		...
		<div class="cart-item-details-grid">
			...
			<div class="cart-item-details">
				...
				<div class="product-quantity">
					<span>
						Quantity: <span class="quantity-label js-quantity-label js-quantity-label-${matchingProduct.id}" data-product-id=${matchingProduct.id}>
						${cartItem.quantity}
						</span>
					</span>
					...
					<div class="cart-item-quantity-container">
						<input type="number" class="quantity-input quantity-input-${matchingProduct.id}" min="1" value="${cartItem.quantity}" data-product-id=${matchingProduct.id}>
...
saveQuantityLinks.forEach((link) => {
	link.addEventListener('click', () => {
		...
		const quantityDisplay = document.querySelector(`.js-quantity-label[data-product-id="${productId}"]`);
